...
const VIDEO_BUCKET = 'https://storage.googleapis.com/streamplay-processed-vid/';
...
export default function Watch() {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      ...
      console.log('Video URL:', `${VIDEO_BUCKET}${current?.videoFileName}`); // Debug URL
      console.log('Current Video:', current); // Debug video object
